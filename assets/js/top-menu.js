gitbook.events.bind("page.change", function() {
    ...
    let topMenu = $(`
        <span class="topnav">
            <a class="logobox" target="_blank" href="https://learn.softuni.org?utm_source=FreeProgrammingBooks&utm_medium=header-menu&utm_campaign=JavaScriptBook"><img class="logo" src="/assets/softuni-global-logo.svg" alt="logo"></a>
