...
All **Truthy** values used in the conditional statement **`if`** will give a positive result and accordingly or program will continue ist execution in the body of the conditional statement (for the purposes of the example here the body of the conditional statement is not formatted correctly).
